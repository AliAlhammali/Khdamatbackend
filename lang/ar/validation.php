...
return [
    ...
    */
    ...
    'not_regex' => 'الحقل :attribute التنسيق غير صحيح',
    ...
    */
    ...
    'attributes' => [
        ...
        'working_hours.*.type' => 'نوع',
        'working_hours.*.days' => 'أيام العمل',
        'working_hours.*.days.*' => 'أيام العمل',
        'working_hours.*.timeslots' => 'الفترات الزمنية',
        'working_hours.*.timeslots.*.start_at' => 'البدء في',
        'working_hours.*.timeslots.*.end_at' => 'النهاية في',
    ],
